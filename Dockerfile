...
RUN apt-get update && apt-get install bazel-3.1.0 -y
...
# RUN cd /dependencies
RUN cd /dependencies && git clone https://github.com/tensorflow/tensorflow.git
RUN echo "test1"
RUN ls -l -a /tensorflow
RUN ./tensorflow/configure
# RUN cd tensorflow/
# RUN ls -l -a tensorflow/
# RUN git checkout v2.3.2

# RUN ls -l -a /dependencies/tensorflow/
# RUN cd /dependencies/tensorflow/
# RUN git branch
# RUN cd tensorflow
# RUN git checkout v2.3.2
# RUN ls
# RUN ./dependencies/tensorflow/configure
